...
Simula una conversación en la terminal como si fueras un cliente de TodoVida.
"""
...
async def main():
    ...
    print()
    print("=" * 55)
    print("   AgentKit — Test Local | TodoVida")
    print("   Agente: Martina")
    print("=" * 55)
    print()
